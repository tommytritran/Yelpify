...
**Yelpify** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
1. Dissmissing keyboard doesn't work
2. Filter options
...
<img src='https://i.imgur.com/2DfT7u4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
